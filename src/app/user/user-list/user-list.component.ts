...
import {CommonDialogComponent} from "../../shared/function/common-dialog/common-dialog.component";
...
export class UserListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.form = this.formBuilder.group({
      nameFilter: [this.filter.name], // Add validators if needed
    });
  ...
  openDeleteConfirmationDialog(user: User): void {
    const dialogRef = this._dialog.open(CommonDialogComponent, {
      width: '300px',
      data: user // Pass necessary data to the dialog
    });
