...
export class UserService {
  ...
  public addUser(body: any):Observable<any>{
    return this.http.post<any>(API_URL+'/api/users',body)
  }
  public deleteUserById(id: number | undefined): Observable<any> {
    const params = new HttpParams().set('id', id !== undefined ? id.toString() : '');
    return this.http.delete<any>(API_URL + '/api/users/delete-by-id', { params });
  }
  //
